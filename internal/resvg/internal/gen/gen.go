...
const (
	targetwasm = "internal/target/wasm32-wasip1/release/resvg.wasm"
)

func main() {
	fmt.Println("Run cargo build --release --target wasm32-wasip1 ...")
	carcmd := exec.Command("cargo", "build", "--release", "--target", "wasm32-wasip1")

...
func UsvgTreeFromData(ctx context.Context, module api.Module, data []byte, options int32, database int32) (int32, error) {
	fn := module.
...
func ResvgTreeRender(ctx context.Context, module api.Module, tree int32, transform int32, pixmap int32) error {
	fn := module.
